                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-xl sm:text-3xl font-bold bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">{activeFolderData.name}</h1>
                      </div>
                      <p className="text-muted-foreground text-sm mt-1">{filtered.length} files · Right-click for options</p>
                    </div>
                  </div>
                ) : (
                  <>
